...
puts new_store.valid?.to_s.upcase
puts "Not valid"
puts "name errors: " + new_store.errors.details[:name].to_s
puts "annual_revenue errors: " + new_store.errors.details[:annual_revenue].to_s
